...
public class MainPunish implements GuiBuilder {
    @Override
    public String name() {
        return "§cSanctions §7(Menu Principal)";
    }
    ...
    public void contents(Player player, Inventory inv) {
        ...
        inv.setItem(21, new ItemBuilder(Material.STAINED_GLASS_PANE, 1, (byte) 7).setName("§f").toItemStack());
        inv.setItem(22, new ItemBuilder(Material.STAINED_GLASS_PANE, 1, (byte) 7).setName("§f").toItemStack());
        inv.setItem(23, new ItemBuilder(Material.STAINED_GLASS_PANE, 1, (byte) 7).setName("§f").toItemStack());
        inv.setItem(24, new ItemBuilder(Material.STAINED_GLASS_PANE, 1, (byte) 7).setName("§f").toItemStack());
        inv.setItem(25, new ItemBuilder(Material.STAINED_GLASS_PANE, 1, (byte) 7).setName("§f").toItemStack());
        inv.setItem(30, new ItemBuilder(Material.STAINED_GLASS_PANE, 1, (byte) 7).setName("§f").toItemStack());
        inv.setItem(31, new ItemBuilder(Material.STAINED_GLASS_PANE, 1, (byte) 7).setName("§f").toItemStack());
        inv.setItem(32, new ItemBuilder(Material.STAINED_GLASS_PANE, 1, (byte) 7).setName("§f").toItemStack());
        inv.setItem(33, new ItemBuilder(Material.STAINED_GLASS_PANE, 1, (byte) 7).setName("§f").toItemStack());
        inv.setItem(34, new ItemBuilder(Material.STAINED_GLASS_PANE, 1, (byte) 7).setName("§f").toItemStack());

        inv.setItem(18, new ItemBuilder(Material.PAPER).setName("§6Catégorie: §fMessages").setLore("§r ", (player.hasPermission("helper.punish") ? "§6§l» §fClique pour afficher la catégorie !" : "§c§l» §cVous n'avez pas la permission d'afficher cette catégorie !")).toItemStack());
    ...
    public void onClick(Player player, Inventory inv, ItemStack current, int slot) throws IOException, NoSuchMethodException {
        if(inv.getName().equals("§cSanctions §7(Menu Principal)")){
            switch (slot){
                case 18:
                    if(current.getItemMeta().getLore().get(1).startsWith("§6§l»")){
                        PluginCore.getGuiManager().open(player, MessagesMenu.class);
                        break;
                    }
                case 27:
                    if(current.getItemMeta().getLore().get(1).startsWith("§6§l»")){
                ...
                case 45:
                    ...
                    break;
                case 53:
                    if(current.getItemMeta().getDisplayName().equals("§cFermer")){
                        player.closeInventory();
                        break;
                    }
            }
